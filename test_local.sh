...
python3 main.py --model-id "stable-diffusion-v1-5/stable-diffusion-v1-5" --download-dir "./models/stable-diffusion-v1-5" --compiled-dir "./compiled_models/stable-diffusion-v1-5" --compilation-mode fast --torch-dtype float16 --hf-token "${HF_TOKEN}"
